...
import { FTDToken, convertTokenInUSD, useKnownTokens } from 'components/providers/known-tokens-provider';
...
const PoolStatistics: FC = () => {
  ...
  const confirmClaim = async <A extends ConfirmTxModalArgs>(args: A) => {
    ...
    try {
      ...
      ftdContract.loadBalance().catch(Error);
        ...
        <div className="p-24">
          <div className="flex align-center justify-space-between mb-24">
            ...
            <div className="flex align-center">
              <Icon name={FTDToken.icon!} className="mr-8" />
              <Text type="p1" weight="semibold" color="primary">
                {formatToken(ftdContract.balance?.unscaleBy(FTDToken.decimals)) ?? '-'}
              </Text>
            </div>
          </div>
          ...
          <div className={cn('flex align-center justify-space-between', s.claimBlock)}>
            <div className="flex flow-row">
              <div className="flex align-center mb-4">
                <Tooltip
                  title={
                    formatToken(poolMeta.contract.toClaim?.unscaleBy(FTDToken.decimals), {
                ...
                <Icon name={FTDToken.icon!} width={24} height={24} />
              </div>
              <Text type="small" weight="semibold" color="secondary">
                Current reward
              </Text>
        ...
        <TxConfirmModal
          ...
          header={
            <div className="flex col-gap-8 align-center justify-center">
              ...
              <Icon name={FTDToken.icon!} width={32} height={32} />
            </div>
          }
          submitText="Claim"
