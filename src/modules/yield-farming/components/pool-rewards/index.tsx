          ...
          <Grid flow="row" gap={2} className={s.item1}>
            ...
            <Grid flow="col" align="center" gap={4} className={s.item1__grid}>
              <Text type="h3" weight="bold" color="primary">
                {formatToken(totalToClaim?.unscaleBy(FTDToken.decimals)) ?? '-'}
              </Text>
              <Icon name={FTDToken.icon!} />
              {walletCtx.isActive && (
                <button
                  type="button"
            ...
            <>
              ...
              <Grid flow="row" gap={2} className={s.item4}>
                <Grid flow="col" gap={8} align="center">
                  <Hint
                    text={`This number shows the $${FTDToken.symbol} rewards you would potentially be able to harvest this epoch, but is subject to change - in case more users deposit, or you withdraw some of your stake.`}>
                    <Text type="p2" color="secondary">
