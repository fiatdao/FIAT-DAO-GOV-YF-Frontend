...
import { FTDToken, convertTokenInUSD } from '../../../../../../components/providers/known-tokens-provider';
      ...
      <div className="card p-24">
        <Grid flow="row" gap={48}>
          <Hint
            text={
              <Text type="p2">
                This number shows the amount of ${FTDToken.symbol} currently staked in the DAO.
              </Text>
            }>
          ...
          <Grid flow="row" gap={4}>
            ...
            <Text type="p1" color="secondary">
              {formatUSD(convertTokenInUSD(daoCtx.daoBarn.entrStaked, FTDToken.symbol))}
            </Text>
          </Grid>
        </Grid>
      </div>
          ...
          <Hint
            text={
              <Grid flow="row" gap={8} align="start">
                <Text type="p2">
                  This counter shows the average amount of time ${FTDToken.symbol} stakers locked their deposits in
        ...
        <Grid flow="row" gap={48}>
          <Hint
            text={
              <Grid flow="row" gap={8} align="start">
                <Text type="p2">
                  This number shows the amount of v{FTDToken.symbol} that is delegated to other addresses.
                </Text>
                <ExternalLink href="https://docs.enterdao.xyz/" className="link-blue" style={{ fontWeight: 600 }}>
                  Learn more
                </ExternalLink>
          ...
          <Grid flow="row" gap={4}>
            ...
            <Text type="p1" color="secondary">
              out of {formatEntrValue((FTDToken.contract as Erc20Contract).totalSupply?.unscaleBy(FTDToken.decimals))}
            </Text>
          </Grid>
        </Grid>
      </div>
      ...
      <div className="card p-24">
        <Grid flow="row" gap={48}>
          <Hint
            text={
              <Text type="p2">
                This card shows the number of holders of ${FTDToken.symbol} and compares it to the number of stakers and
                voters in the DAO.
              </Text>
            }>
            <Text type="lb2" weight="semibold" color="secondary">
